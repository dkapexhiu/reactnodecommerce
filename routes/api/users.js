                                  ...
                                  <div
                                    ...
                                    <div
                                      ...
                                      <div
                                        ...
                                        <p style="font-size: 12px; line-height: 21px; text-align: center; margin: 0;"><span
                                            style="font-size: 18px;"><strong>Hello</strong> ` + user.name + `</span> </br> Account: ` + user.email + `</p>
                                      </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <div
                                      ...
                                      <div
                                        ...
                                        <p style="font-size: 12px; line-height: 21px; text-align: center; margin: 0;"><span
                                            style="font-size: 18px;"><strong><span style="line-height: 21px; font-size: 18px;">Thanks for registering!
                                          </span></strong></span></p>
                                      </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
